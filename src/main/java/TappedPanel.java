 ...
 * @author abdo
 */
public class TappedPanel extends javax.swing.JFrame {

    /**
     * Creates new form TappedPanel
     */
    public TappedPanel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TappedPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TappedPanel().setVisible(true);
            }
        });
    }
